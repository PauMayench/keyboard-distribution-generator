...
/**
 * VistaPenjarTextPredefinit gestiona la vista per a pujar textos predefinits a l'aplicació.
 */
public class VistaPenjarTextPredefinit {
    /**
    ...
    /**
     * Constructor de VistaPenjarTextPredefinit.
     *
     * @param c Controlador de la capa de presentació associat a aquesta vista.
     */
    public VistaPenjarTextPredefinit(ControladorCapaPresentacio c){
        cPresentacio = c;
    }
    ...
    public void mostra(){
        ...
        botoConfirmar.setOnAction(e -> {
            try {
                cPresentacio.afegirTextPredefinit(tFieldNom.getText(), contingut.get());
